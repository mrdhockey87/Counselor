...
{
    public partial class UserGeneratedOrTemplateDocDialog : Form
    {
        public UserGeneratedOrTemplateDocDialog()
        {
            InitializeComponent();
        }

        private void UserGeneratedOrTemplateDocDialog_Load(object sender, EventArgs e)
        {
        ...
        private void UserGeneratedOrTemplateDocDialog_FormClosing(object sender, FormClosingEventArgs e)
        {
