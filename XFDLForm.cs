...
{
    public class XFDLForm : FormInterface
    {
        protected string filename;
        protected System.Xml.XmlDocument document;


        public XFDLForm(string templateName, string newFormFilename)
        {
            FileUtils.CreateNewCopy(templateName, newFormFilename);
            LoadForm(newFormFilename);
        }
        ...
        public new void SetValue(string propertyName, string value)
        {
